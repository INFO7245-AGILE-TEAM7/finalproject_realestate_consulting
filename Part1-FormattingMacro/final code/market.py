...
marketing_analyst_names = pd.read_excel("airbnb files/Airbnb_October_2019.xlsx")
sales_rep_names = pd.read_excel("airbnb files/Airbnb_October_2019_1.xlsx")
sal =pd.read_excel("airbnb files/Airbnb_October_2019_2.xlsx")
